...
final class MarathonPackageRunner(adminRouter: AdminRouter) extends PackageRunner[MarathonApp] {

  def launch(renderedConfig: Json, option: Option[String] = None)(implicit session: RequestSession): Future[MarathonApp] = {
